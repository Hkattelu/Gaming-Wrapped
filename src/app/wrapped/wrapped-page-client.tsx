...
export default function WrappedPageClient({ initialData, initialId }: { initialData?: WrappedData | null, initialId?: string | null }) {
  const [data, setData] = useState<WrappedData | null>(initialData || null);
