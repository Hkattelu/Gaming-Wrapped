...
describe('GET /api/wrapped/[id]/og', () => {
  ...
  type OgImageResponseOptions = { width?: number; height?: number; fonts?: Array<unknown> };
  ...
  const getImageResponseOptions = () => {
    ...
    const options = mockImageResponse.mock.calls[0]?.[1] as OgImageResponseOptions | undefined;
  ...
  it('returns 200 image response when everything succeeds', async () => {
    ...
    expect(options.fonts?.length).toBe(2);
  });
