...
You didn't just play games—you *lived* them. 🎮`,
    ...
    },
    {
      ...
      recommendations: [
        'Disco Elysium - For that deep RPG narrative itch',
        'Satisfactory - Since the factory must grow (in 3D)',
        'Hollow Knight - A challenging metroidvania masterpiece',
        'The Witcher 3 - If you somehow haven\'t played it yet',
      ],
    },
  ],
};
